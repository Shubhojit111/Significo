    ...
    return (
        <div className='home2 h-screen bg-[#AEDEE0] text-black   w-full flex gap-10 px-12 py-24   relative '>
            ...
            <div className="left w-1/2  flex flex-col items-start gap-3.5">
                <p className='w-[80%] text-[2.5vh] leading-7 font-semibold'>Significo is a leading health software creator founded on the belief
                    that technology can transform healthcare to put people first.
                    Whether they are employees, members, customers, or clients, we
                    never forget the real people we’re designing for.</p>

                <h1 className='font-[flight] text-[8vh] leading-18'>We Craft Human-Centric Health Software</h1>
                <button className='border-2 px-10 py-4 font-semibold'>OUR SOLUTIONS</button>
            </div>

            <div className="cards h-fit pb-20 w-[65vh] flex flex-col gap-8 -translate-y-150 ">
               <Card heading={"Driven by Purpose"} text={"We believe technology can dramatically improve the experience of managing health, and when crafted with empathy, intention, and expertise, impact lives at scale."}/>
               <Card heading={"Driven by Purpose"} text={"We believe technology can dramatically improve the experience of managing health, and when crafted with empathy, intention, and expertise, impact lives at scale."}/>
               <Card heading={"Driven by Purpose"} text={"We believe technology can dramatically improve the experience of managing health, and when crafted with empathy, intention, and expertise, impact lives at scale."}/>
               <Card heading={"Driven by Purpose"} text={"We believe technology can dramatically improve the experience of managing health, and when crafted with empathy, intention, and expertise, impact lives at scale."}/>
